...
Sim_Vis_Vis_prob = zeros(16,1);
Sim_SPL_Vis_prob = zeros(16,1);
Sim_SMG_Vis_prob = zeros(16,1);
Sim_Vis_SPL_prob = zeros(16,1);
Sim_SPL_SPL_prob = zeros(16,1);
Sim_SMG_SPL_prob = zeros(16,1);
Sim_Vis_SMG_prob = zeros(16,1);
Sim_SPL_SMG_prob = zeros(16,1);
Sim_SMG_SMG_prob = zeros(16,1);
for k = 1:16
...
Sim_Vis_Vis_prob(k,1) = Sim_GCM{k,1}.Pp.B(1,1);
Sim_SPL_Vis_prob(k,1) = Sim_GCM{k,1}.Pp.B(1,2);
Sim_SMG_Vis_prob(k,1) = Sim_GCM{k,1}.Pp.B(1,3);
Sim_Vis_SPL_prob(k,1) = Sim_GCM{k,1}.Pp.B(2,1);
Sim_SPL_SPL_prob(k,1) = Sim_GCM{k,1}.Pp.B(2,2);
Sim_SMG_SPL_prob(k,1) = Sim_GCM{k,1}.Pp.B(2,3);
Sim_Vis_SMG_prob(k,1) = Sim_GCM{k,1}.Pp.B(3,1);
Sim_SPL_SMG_prob(k,1) = Sim_GCM{k,1}.Pp.B(3,2);
Sim_SMG_SMG_prob(k,1) = Sim_GCM{k,1}.Pp.B(3,3);
end
Sim_Vis_Vis(Sim_Vis_Vis_prob<0.7)=[];
Sim_SPL_Vis(Sim_SPL_Vis_prob<0.7)=[];
Sim_SMG_Vis(Sim_SMG_Vis_prob<0.7)=[];
Sim_Vis_SPL(Sim_Vis_SPL_prob<0.7)=[];
Sim_SPL_SPL(Sim_SPL_SPL_prob<0.7)=[];
Sim_SMG_SPL(Sim_SMG_SPL_prob<0.7)=[];
Sim_Vis_SMG(Sim_Vis_SMG_prob<0.7)=[];
Sim_SPL_SMG(Sim_SPL_SMG_prob<0.7)=[];
Sim_SMG_SMG(Sim_SMG_SMG_prob<0.7)=[];
...
for k = 1:length(Sim_Vis_Vis)
   plot(1,Sim_Vis_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_Vis_Vis)
   plot(2,Loc_Vis_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SPL_Vis)
   plot(4,Sim_SPL_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SPL_Vis)
   plot(5,Loc_SPL_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SMG_Vis)
   plot(7,Sim_SMG_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SMG_Vis)
   plot(8,Loc_SMG_Vis(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_Vis_SPL)
   plot(10,Sim_Vis_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_Vis_SPL)
   plot(11,Loc_Vis_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SPL_SPL)
   plot(13,Sim_SPL_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SPL_SPL)
   plot(14,Loc_SPL_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SMG_SPL)
   plot(16,Sim_SMG_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SMG_SPL)
   plot(17,Loc_SMG_SPL(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_Vis_SMG)
   plot(19,Sim_Vis_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_Vis_SMG)
   plot(20,Loc_Vis_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SPL_SMG)
   plot(22,Sim_SPL_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SPL_SMG)
   plot(23,Loc_SPL_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
for k = 1:length(Sim_SMG_SMG)
   plot(25,Sim_SMG_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end

for k = 1:length(Loc_SMG_SMG)
   plot(26,Loc_SMG_SMG(k),'marker','o','markersize',6,...
    'markeredgecolor','k','markerfacecolor','k');  
end
...
legend([b,c],' Inference Task',' Perception Task')
ylim([-1.5 2])
hy = ylabel('Effect strength');
...
[h(1),p(1)] = ttest2(Sim_Vis_Vis,Loc_Vis_Vis);
[h(2),p(2)] = ttest2(Sim_SPL_Vis,Loc_SPL_Vis);
[h(3),p(3)] = ttest2(Sim_SMG_Vis,Loc_SMG_Vis);
[h(4),p(4)] = ttest2(Sim_Vis_SPL,Loc_Vis_SPL);
[h(5),p(5)] = ttest2(Sim_SPL_SPL,Loc_SPL_SPL);
[h(6),p(6)] = ttest2(Sim_SMG_SPL,Loc_SMG_SPL);
[h(7),p(7)] = ttest2(Sim_Vis_SMG,Loc_Vis_SMG);
[h(8),p(8)] = ttest2(Sim_SPL_SMG,Loc_SPL_SMG);
[h(9),p(9)] = ttest2(Sim_SMG_SMG,Loc_SMG_SMG);
